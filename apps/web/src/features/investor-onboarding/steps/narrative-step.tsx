...
/**
 * Optional prose (portfolio names, extra context). Skipping is an explicit
 * state, never an empty string pretending to be an answer.
 */
export function NarrativeStep({
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (trimmed.length === 0) {
      ...
      setError("A line or two is enough.");
      return;
    }
